...
export const Footer = () => {
  return (
    <footer className="bg-slate-900/80 backdrop-blur-sm border-t border-orange-500/10 py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          <div className="lg:col-span-2">
            <Link to="/" className="flex items-center space-x-2 mb-4">
              <span className="text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-orange-500 to-orange-400">Mentor Matrix</span>
            </Link>
            ...
            <div className="flex space-x-4 mt-6">
              <motion.a 
                ...
                className="h-10 w-10 bg-orange-500/10 hover:bg-orange-500/20 rounded-full flex items-center justify-center transition-colors"
                aria-label="GitHub"
              >
          ...
          {[
            ...
            <div key={section.title}>
              <h3 className="font-medium text-slate-100 mb-4">{section.title}</h3>
