...
const MeetingService = {
    ...
    createMeeting: async (meetingData) => {
        try {
            const response = await axiosInstance.post('/meeting/create', meetingData);
    ...
    getProjectMeetings: async (projectId) => {
        try {
            const response = await axiosInstance.get(`/meeting/project/${projectId}`);
